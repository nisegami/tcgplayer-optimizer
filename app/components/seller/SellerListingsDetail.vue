                            ...
                            <table class="w-full text-xs">
                                <thead>
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <th class="py-1 text-left">Condition</th>
                                        <th class="py-1 text-left">Edition</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr
                                    ...
                                    >
                                        <td class="py-1">{{ formatPrice(listing.price) }}</td>
                                        <td class="py-1">{{ listing.quantity }}</td>
                                        <td class="py-1">{{ listing.condition }}</td>
                                        <td class="py-1">{{ listing.edition }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
